...
public class Principal {
    ...
    public static void main (String[] args){
     ...
     Gerente g1 = new Gerente("Luisa",2000,"09/09/1968", new Departamento("Departamento1"));
     listaEmpleados.add(g1);
     Director d1 =new Director("Jorge", 5000, "02/03/1974",new Departamento("Departamento2"),"1234BBB");
